...
const FName ATP_TwinStickPawn::FireForwardBinding("FireForward");
const FName ATP_TwinStickPawn::FireRightBinding("FireRight");

ATP_TwinStickPawn::ATP_TwinStickPawn()
{	
...
void ATP_TwinStickPawn::ShotTimerExpired()
{
	bCanFire = true;
}
